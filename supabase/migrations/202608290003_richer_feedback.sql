alter table public.question_evaluations
  add column missing_points jsonb not null default '[]'::jsonb,
  add column better_structure jsonb not null default '[]'::jsonb,
  add column improved_answer text not null default '';
...
revoke all on function public.record_interview_evidence(uuid, text, numeric, jsonb, jsonb, jsonb, jsonb, jsonb, text) from public;
grant execute on function public.record_interview_evidence(uuid, text, numeric, jsonb, jsonb, jsonb, jsonb, jsonb, text) to authenticated;
...
revoke all on function public.record_conversation_turn(uuid, text, numeric, jsonb, jsonb, jsonb, jsonb, jsonb, text, uuid, text, jsonb) from public;
grant execute on function public.record_conversation_turn(uuid, text, numeric, jsonb, jsonb, jsonb, jsonb, jsonb, text, uuid, text, jsonb) to authenticated;
...
begin
  ...
  loop
    ...
    insert into public.session_evaluations (
      ...
      coalesce(v_evaluation -> 'missing_points', '[]'::jsonb),
      coalesce(v_evaluation -> 'better_structure', '[]'::jsonb),
      trim(coalesce(v_evaluation ->> 'improved_answer', ''))
    );
