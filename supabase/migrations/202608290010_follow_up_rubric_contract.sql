alter table public.interview_questions
  add column rubric_criteria jsonb not null default '[]'::jsonb,
  add column parent_question_id uuid;

alter table public.interview_questions
  add constraint interview_questions_parent_question_id_fkey
  foreign key (parent_question_id, user_id) references public.interview_questions (id, user_id) on delete cascade;
